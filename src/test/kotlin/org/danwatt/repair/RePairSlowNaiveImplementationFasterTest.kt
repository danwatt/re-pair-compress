...
import org.danwatt.repair.experiments.RePairFasterNaiveImplementation
import org.junit.jupiter.api.Test

class RePairSlowNaiveImplementationFasterTest {
    private val compressor = RePairFasterNaiveImplementation<Int>()

    private fun pairMarkerGenerator(pairNumber: Int, p: Pair<Int,Int>): Int {
    ...
    fun `String variation`() {
        val result = RePairFasterNaiveImplementation<String>().compress(
